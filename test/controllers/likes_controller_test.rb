...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference("Like.count") do
      post likes_url, params: { like: { identifier: @like.identifier, song_id: @like.song_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { identifier: @like.identifier, song_id: @like.song_id } }
